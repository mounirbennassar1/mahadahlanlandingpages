...
function Card({ review }: { review: Review }) {
  return (
    <div className="w-[360px] flex-none rounded-[20px] border border-[rgba(166,124,61,0.2)] bg-[var(--color-nkl-card)] px-6 py-[26px]">
      <Icon.Quote className="mb-3 size-[26px] fill-[rgba(201,156,78,0.5)] text-[rgba(201,156,78,0.5)]" />
      <p className="mb-4 text-[0.95rem] leading-[1.8] font-light text-[rgba(39,28,17,0.75)]">
        {review.quote}
      </p>
...
function MarqueeRow({
  ...
  return (
    ...
    >
      <div
        className={`nkl-marquee-track gap-5 ${reverse ? "nkl-marquee-reverse" : ""}`}
        style={{ "--nkl-marquee-duration": duration } as CSSProperties}
      >
        {[0, 1].map((copy) => (
