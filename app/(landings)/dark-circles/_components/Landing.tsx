...
export function Landing({
  ...
  content: ContentOf<typeof DARK_CIRCLES>;
}) {
            ...
            <div className="space-y-8 text-right">
              ...
              <h1 className="font-bold leading-[1.1] tracking-tight text-[var(--color-dc-ink)]" style={{ fontSize: "clamp(2.5rem, 5.5vw, 4.75rem)" }}>
                <span className="dc-line-mask">
                  <span className="dc-line">{content.hero.line1}</span>
                </span>
                <span className="dc-line-mask">
                  <span className="dc-line">
                    {content.hero.line2} <em className="not-italic text-[var(--color-dc-primary)]">{content.hero.line2Highlight}</em>
                  </span>
                </span>
                <span className="dc-line-mask">
                  <span className="dc-line">
                    {content.hero.line3}<span className="text-[var(--color-dc-primary)]">.</span>
                  </span>
                </span>
              </h1>
      ...
      <section id="problem" className="mx-auto max-w-7xl scroll-mt-24 px-5 py-16 sm:px-6 sm:py-20 lg:py-24">
        ...
        >
          <motion.div variants={fadeUp} className="space-y-5 text-right">
            ...
            >
              {content.problem.title} <em className="not-italic text-[var(--color-dc-primary)]">{content.problem.highlight}</em>.
            </h2>
        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-6">
          ...
          >
            ...
            <motion.h2
              ...
              style={{ fontSize: "clamp(2rem, 3.6vw, 3rem)" }}
            >
              {content.process.title} <em className="not-italic text-[var(--color-dc-accent)]">{content.process.highlight}</em>.
            </motion.h2>
            <motion.p
              variants={fadeUp}
        ...
        >
          <motion.div variants={fadeUp} className="order-2 space-y-5 text-right lg:order-1">
            ...
            <h2
              ...
              style={{ fontSize: "clamp(2rem, 3.6vw, 3rem)" }}
            >
              {content.doctor.namePre} <em className="not-italic text-[var(--color-dc-primary)]">{content.doctor.nameHighlight}</em> {content.doctor.namePost}
            </h2>
            ...
            <blockquote className="border-r-4 border-[var(--color-dc-primary)]/30 bg-[var(--color-dc-surface)] px-6 py-5 text-right text-base leading-loose text-[var(--color-dc-ink-soft)]">
              «{content.doctor.quote}»
            </blockquote>
            <div className="grid grid-cols-2 gap-4 pt-4">
              {content.doctor.credentials.map((c) => (
                <div
                  key={c.label}
          ...
          <motion.div variants={fadeUp} className="order-1 lg:order-2">
            <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-[1.75rem] border-[6px] border-white shadow-[0_30px_70px_-30px_rgba(154,90,78,0.4)] sm:max-w-md sm:rounded-[2rem] sm:border-8">
              ...
              <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-[var(--color-dc-ink)]/30 to-transparent p-6 text-white">
                <p className="font-bold">{content.doctor.photoName}</p>
                <p className="text-xs opacity-85">{content.doctor.photoCaption}</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          ...
          >
            ...
            <motion.h2
              ...
              style={{ fontSize: "clamp(2rem, 3.6vw, 3rem)" }}
            >
              {content.testimonials.title} <em className="not-italic text-[var(--color-dc-primary)]">{content.testimonials.highlight}</em> {content.testimonials.titleTail}
            </motion.h2>
          </motion.div>
      ...
      <section id="faq" className="mx-auto max-w-3xl scroll-mt-24 px-5 py-16 sm:px-6 sm:py-20 lg:py-24">
        ...
        >
          ...
          <motion.h2
            ...
            style={{ fontSize: "clamp(2rem, 3.6vw, 3rem)" }}
          >
            {content.faq.title} <em className="not-italic text-[var(--color-dc-primary)]">{content.faq.highlight}</em>
          </motion.h2>
        </motion.div>
      ...
      >
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 px-5 sm:px-6 lg:grid-cols-[1.2fr_1fr] lg:gap-12">
          ...
          >
            ...
            >
              {content.booking.title} <em className="not-italic text-[var(--color-dc-primary)]">{content.booking.highlight}</em>.
            </motion.h2>
            <motion.p
              variants={fadeUp}
