        ...
        >
          ...
          <div className="relative mx-auto grid max-w-7xl items-center gap-10 px-5 sm:gap-12 sm:px-6 lg:grid-cols-[1.05fr_1fr]">
            <div className="space-y-8 text-right">
              ...
              >
                الهالات والتصبّغات تحت العين ليست دائماً بسبب الإرهاق فقط — أحياناً
                تكون نتيجة تصبّغات، فجوة تحت العين، أو طبيعة الجلد نفسه. لذلك نحرص
                على تشخيص الحالة بدقة واختيار العلاج المناسب لكل حالة بشكل طبيعي
                ومدروس.
              </p>
      ...
      <section id="problem" className="mx-auto max-w-7xl scroll-mt-24 px-5 py-16 sm:px-6 sm:py-20 lg:py-24">
        ...
        >
          <motion.div variants={fadeUp} className="space-y-5 text-right">
            ...
            >
              أربع أسباب مختلفة — ولكل سبب <em className="not-italic text-[var(--color-dc-primary)]">علاجه الخاص</em>.
            </h2>
            <p className="text-lg leading-loose text-[var(--color-dc-ink-soft)]">
              ليست كل هالات تحتاج نفس العلاج. الفرق الحقيقي يبدأ حين نفهم السبب
              الأساسي للهالات تحت العين، لأن كل حالة تحتاج طريقة مختلفة في التعامل
              والعلاج.
            </p>
          </motion.div>
