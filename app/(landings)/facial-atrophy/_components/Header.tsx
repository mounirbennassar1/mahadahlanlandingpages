  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[74px] max-w-[1160px] items-center justify-between px-[22px]">
        ...
        />
        <PayButton
          className="inline-flex cursor-pointer items-center gap-2 rounded-full px-[22px] py-2.5 text-[0.88rem] font-extrabold text-[var(--color-faa-cta-ink)] shadow-[0_10px_28px_-10px_rgba(217,179,108,0.6)] transition-transform duration-300 hover:-translate-y-0.5"
