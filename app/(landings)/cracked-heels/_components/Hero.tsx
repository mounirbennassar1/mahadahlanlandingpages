      ...
      <div className="relative mx-auto grid max-w-[1180px] items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
        ...
        <div className="crh-copy flex flex-col items-center text-center lg:items-start lg:text-right">
          ...
          <div className="crh-h mt-8 flex flex-wrap justify-center gap-3.5 lg:justify-start">
            <PayButton
              className="inline-flex cursor-pointer items-center gap-2.5 rounded-full px-[32px] py-4 text-base font-extrabold text-[#1C120C] shadow-[0_18px_44px_-14px_rgba(212,175,55,0.5)] transition-all duration-300 hover:-translate-y-[3px] hover:shadow-[0_24px_54px_-14px_rgba(228,200,126,0.6)]"
