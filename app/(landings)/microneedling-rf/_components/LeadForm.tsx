...
export function LeadForm() {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-[1.75rem] border border-[var(--color-mrf-line)] bg-[var(--color-mrf-surface)] p-5 shadow-[0_30px_60px_-30px_rgba(0,0,0,0.18)] sm:rounded-[2rem] sm:p-7 lg:p-9">
      <AnimatePresence mode="wait">
        {status.kind === "ok" ? (
          ...
          >
            <div className="flex size-16 items-center justify-center rounded-full bg-[var(--color-mrf-accent)]/30">
          ...
          >
            ...
            <motion.button
              ...
              className="flex w-full items-center justify-center gap-3 rounded-2xl bg-[var(--color-mrf-primary)] px-7 py-4 text-base font-bold text-white shadow-lg transition-colors hover:bg-[var(--color-mrf-primary-dim)] disabled:opacity-70"
            >
              {submitting ? (
                <>
...
function Field({
  ...
  return (
    <div>
      <label
        htmlFor={id}
        className="mb-2 block text-sm font-bold text-[var(--color-mrf-ink)]"
      >
        {label}
      </label>
      <input
        ...
        disabled={disabled}
        required
        className="w-full rounded-xl border border-[var(--color-mrf-line)] bg-[var(--color-mrf-bg)] px-4 py-3 text-base text-[var(--color-mrf-ink)] outline-none transition-colors placeholder:text-[var(--color-mrf-muted)] focus:border-[var(--color-mrf-primary)] focus:ring-4 focus:ring-[var(--color-mrf-primary)]/15 disabled:opacity-60 sm:py-3.5"
      />
    </div>
  );
}
