...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: "نعم. نوفر التقسيط عبر تابي وتمارا داخل العيادة على ٤ دفعات متساوية بدون فوائد، بموافقة فورية عند الاستقبال وبدون بطاقة ائتمانية. كما نقبل الدفع نقداً وبالبطاقات ومدى.",
  },
  {
  ...
  },
  {
    ...
    a: "اتصلي بنا أو أرسلي رسالة عبر واتساب ونعيد جدولة موعدك بلا رسوم. نقدّر إخبارنا قبل ٢٤ ساعة على الأقل ليستفيد غيرك من الموعد.",
  },
];
